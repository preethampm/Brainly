...
var ReactTags = (props) => {
  ...
  const tagsComponent = !readOnly ? (0, import_jsx_runtime6.jsxs)("div", { className: allClassNames.tagInput, children: [
    ...
    clearAll && tags.length > 0 && (0, import_jsx_runtime6.jsx)(ClearAllTags_default, { "aria-label": ariaAttrs == null ? void 0 : ariaAttrs.clearAllLabel, classNames: allClassNames, onClick: handleClearAll }),
